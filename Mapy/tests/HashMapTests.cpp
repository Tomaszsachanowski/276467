...
//---------------------------------------------------------
BOOST_AUTO_TEST_CASE_TEMPLATE(Moj_Test,
                              K,
                              TestedKeyTypes)
{
  Map<K> map;
  ...
  const auto it = map.find(333);

  BOOST_CHECK(it->first == 333);
    BOOST_CHECK(it->second == "Dana");

}
BOOST_AUTO_TEST_CASE_TEMPLATE(Moj_Test2,
                              K,
                              TestedKeyTypes)
{
  Map<K> map;
  ...
  BOOST_CHECK(it->first == 333);
    BOOST_CHECK(it->second != "Wiadomosc");
